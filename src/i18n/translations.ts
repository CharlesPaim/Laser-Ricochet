...
export const translations: Record<SupportedLang, Record<string, string>> = {
  en: {
    ...
    instructions_1: 'MOUSE / TOUCH: Move deflector along orbital defense rail',
    instructions_2: 'CLICK / TAP ON CONTACT: PARRY (Reflective counter-strike)',
  ...
  pt: {
    ...
    instructions_1: 'MOUSE / TOUCH: Posiciona a lâmina no trilho orbital defensivo',
    instructions_2: 'CLIQUE / TOQUE NO IMPACTO: PARRY (Contra-ataque reflexivo acelerado)',
